...
let __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, generator) {
...
let HttpCodes = {};
HttpCodes["OK"] = 200;
HttpCodes["MultipleChoices"] = 300;
HttpCodes["MovedPermanently"] = 301;
HttpCodes["ResourceMoved"] = 302;
HttpCodes["SeeOther"] = 303;
HttpCodes["NotModified"] = 304;
HttpCodes["UseProxy"] = 305;
HttpCodes["SwitchProxy"] = 306;
HttpCodes["TemporaryRedirect"] = 307;
HttpCodes["PermanentRedirect"] = 308;
HttpCodes["BadRequest"] = 400;
HttpCodes["Unauthorized"] = 401;
HttpCodes["PaymentRequired"] = 402;
HttpCodes["Forbidden"] = 403;
HttpCodes["NotFound"] = 404;
HttpCodes["MethodNotAllowed"] = 405;
HttpCodes["NotAcceptable"] = 406;
HttpCodes["ProxyAuthenticationRequired"] = 407;
HttpCodes["RequestTimeout"] = 408;
HttpCodes["Conflict"] = 409;
HttpCodes["Gone"] = 410;
HttpCodes["TooManyRequests"] = 429;
HttpCodes["InternalServerError"] = 500;
HttpCodes["NotImplemented"] = 501;
...
class HttpClientResponse {
    ...
    readBody() {
        return new Promise((resolve) => __awaiter(this, void 0, function* () {
            const chunks = [];
            const encodingCharset = obtainContentCharset(this);
