...
import _wrapAsync from '../node_modules/async/internal/wrapAsync.js';

function queue(worker, payload) {
    let concurrency = 1;
    ...
    var q = {
        _tasks: new _DoublyLinkedList.default(),
        ...
        *[Symbol.iterator]() {
        ...
        process() {
            ...
            while (!q.paused && numRunning < q.concurrency && q._tasks.length) {
                ...
                var cb = (0, _onlyOnce.default)(_createCB(tasks));
                _worker(data, cb);
            }
            isProcessing = false;
        },
