...
const KuduServiceUtility_1 = require("./KuduServiceUtility");
...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield kuduService.getAppSettings();
            ...
            yield kuduServiceUtility.deployUsingOneDeploy(webPackage, { slotName: "production", commitMessage: "" });
        }
        catch (error) {
