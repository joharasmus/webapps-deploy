...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield WebAppDeployer.DeployWebApp(publishProfileContent, appPackage);
        }
        catch (error) {
...
class WebAppDeployer {
    static DeployWebApp(publishProfileContent, appPackage) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let kuduService = new azure_app_kudu_service_1.Kudu(uri, { username: username, password: password });
