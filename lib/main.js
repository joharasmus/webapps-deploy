...
const BaseWebAppDeploymentProvider_1 = require("./DeploymentProvider/BaseWebAppDeploymentProvider");
const PublishProfileWebAppValidator_1 = require("./InputValidator/PublishProfileWebAppValidator");
...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            let validator = new PublishProfileWebAppValidator_1.PublishProfileWebAppValidator();
            yield validator.validate();
            let type = BaseWebAppDeploymentProvider_1.DEPLOYMENT_PROVIDER_TYPES.PUBLISHPROFILE;
